...
// 	const auto GetNodesToUpdateWithinBounds = [](const FNodeBounds& Bounds, const layer_idx LayerIdx, const rsap_direction PositiveDirectionsToTrack) -> FNodeUpdateMap
// 	{
...
// 	const auto FillChunksToUpdate = [&ChunksToUpdate, &GetNodesToUpdateWithinBounds](const chunk_morton ChunkMorton, const rsap_direction ChunkPositiveDirections, const FNodeBounds& Bounds, const layer_idx LayerIdx)
// 	{
...
// 			{
// 				PreviousRemainder.ForEachChunk([&FillChunksToUpdate, StartingLayerIdx](const chunk_morton ChunkMorton, const rsap_direction ChunkPositiveDirections, const FNodeBounds& MortonBounds)
// 				{
...
// 		}
// 		
// 		CurrentRounded.ForEachChunk([&FillChunksToUpdate, StartingLayerIdx](const chunk_morton ChunkMorton, const rsap_direction ChunkPositiveDirections, const FNodeBounds& MortonBounds)
// 		{
// 			FillChunksToUpdate(ChunkMorton, ChunkPositiveDirections, MortonBounds, StartingLayerIdx);
// 		});
// 	}
...
// 		if(!FChunk::HasWorldOverlap(World, ChunkLocation))
// 		{
