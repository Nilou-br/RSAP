 ...
 */
TMap<FChunk*, TBoundsPair<F3DVector10>> GetChunkMortonBoundsPairs(const FNavMeshPtr& NavMeshPtr, const TBoundsPair<>& BeforeAfterBoundsPair)
{
...
void FNavMeshUpdater::UpdateStatic(const TArray<TBoundsPair<>>& BeforeAfterBoundsPairs)
{
	...
	{
		TMap<FChunk*, TBoundsPair<F3DVector10>> MortonBoundsPairs = GetChunkMortonBoundsPairs(NavMeshPtr, BeforeAfterBoundsPair);
